...
% The performance remains food, illustrated by the residual.., which is vastly superior to the resitual in...
...
% (emp ev. sug.)
% 1- Real sky images (clean, dirty, gt, hp iht lp iht) vs. real data: lp nin state of arttan ve hp ile ayni yaptigini

% 2- exact recovery per epoch vs source recovery per epoch for all algorithms to justify iht is good

% 3- exact recovery vs. k/m for both simulated and real data (using hp-lp) vs source recovery

% 3- monitoring rip? and error? for hp and lp case?


% 4- speed up on fpga for synthetic and real data
